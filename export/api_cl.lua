...
Anims.Block = {1,2,24,257,25,263,Keys['R'],Keys['SPACE'],Keys['Q'],Keys['TAB'],Keys['F'],Keys['F1'],Keys['F2'],Keys['F3'],Keys['F6'],Keys['V'],Keys['C'],Keys['X'],59,71,72,47,264,257,140,141,142,143,75,27}
...
Anims.play = function(dict, name, params, duration, prevent, block, ped)
    ...
    if prevent then
        local lid = CreateLoop(function(loopId)
